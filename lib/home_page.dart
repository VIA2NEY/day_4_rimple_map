    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: ListView(
                        ...
                        children: <Widget>[
                          makeItem(image: 'assets/place.jpg'),
                          makeItem(image: 'assets/place3.jpg'),
                          makeItem(image: 'assets/place2.jpg'),
                        ],
                      ),
                    ),
                    SizedBox(height: 30,)
          ...
          makePoint(top: 300.0, left: 200.0, image: 'assets/place.jpg' ),
          makePoint(top: 450.0, left: 50.0, image: 'assets/place3.jpg'),
          makePoint(top: 400.0, left: 160.0, image: 'assets/place2.jpg'),
        ],
      )
    );
  }
